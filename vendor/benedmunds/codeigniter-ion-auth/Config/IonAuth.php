...
class IonAuth extends \CodeIgniter\Config\BaseConfig
{
	 ...
	 */
	public $siteTitle                = 'Kopmensa POS';       // Site Title, example.com
	public $adminEmail               = 'admin@kopmensa.com'; // Admin Email, admin@example.com
	...
	public $minPasswordLength        = 6;                   // Minimum Required Length of Password (not enforced by lib - see note above)
