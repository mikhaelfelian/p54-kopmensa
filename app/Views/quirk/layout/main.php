...
<head>
  ...
  <!-- Growl CSS -->
  <link rel="stylesheet" href="<?= base_url('public/assets/theme/quirk/lib/growl/jquery.growl.css')?>">
  <link rel="stylesheet" href="<?= base_url('public/assets/theme/quirk/lib/animate.css/animate.css')?>">
  ...
  <!-- Growl JS -->
  <script src="<?= base_url('public/assets/theme/quirk/lib/growl/jquery.growl.js')?>"></script>
        ...
        <div class="tab-pane" id="contactmenu">
          ...
          <ul class="media-list media-list-contacts">
            <li class="media">
              <a href="#">
                <div class="media-left">
                    <img class="media-object img-circle" src="<?= base_url('public/assets/theme/quirk/images/photos/user1.png') ?>" alt="">
                </div>
                <div class="media-body">
            ...
            <li class="media">
              <a href="#">
                <div class="media-left">
                  <img class="media-object img-circle" src="<?= base_url('public/assets/theme/quirk/images/photos/user2.png') ?>" alt="">
                </div>
                <div class="media-body">
            ...
            <li class="media">
              <a href="#">
                <div class="media-left">
                  <img class="media-object img-circle" src="<?= base_url('public/assets/theme/quirk/images/photos/user3.png') ?>" alt="">
                </div>
                <div class="media-body">
            ...
            <li class="media">
              <a href="#">
                <div class="media-left">
                  <img class="media-object img-circle" src="<?= base_url('public/assets/theme/quirk/images/photos/user4.png') ?>" alt="">
                </div>
                <div class="media-body">
            ...
            <li class="media">
              <a href="#">
                <div class="media-left">
                  <img class="media-object img-circle" src="<?= base_url('public/assets/theme/quirk/images/photos/user5.png') ?>" alt="">
                </div>
                <div class="media-body">
            ...
            <li class="media">
              <a href="#">
                <div class="media-left">
                  <img class="media-object img-circle" src="<?= base_url('public/assets/theme/quirk/images/photos/user6.png') ?>" alt="">
                </div>
                <div class="media-body">
            ...
            <li class="media">
              <a href="#">
                <div class="media-left">
                  <img class="media-object img-circle" src="<?= base_url('public/assets/theme/quirk/images/photos/user7.png') ?>" alt="">
                </div>
                <div class="media-body">
            ...
            <li class="media">
              <a href="#">
                <div class="media-left">
                  <img class="media-object img-circle" src="<?= base_url('public/assets/theme/quirk/images/photos/user8.png') ?>" alt="">
                </div>
                <div class="media-body">
            ...
            <li class="media">
              <a href="#">
                <div class="media-left">
                  <img class="media-object img-circle" src="<?= base_url('public/assets/theme/quirk/images/photos/user9.png') ?>" alt="">
                </div>
                <div class="media-body">
            ...
            <li class="media">
              <a href="#">
                <div class="media-left">
                  <img class="media-object img-circle" src="<?= base_url('public/assets/theme/quirk/images/photos/user10.png') ?>" alt="">
                </div>
                <div class="media-body">
