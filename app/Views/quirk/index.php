...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url('public/file/app/'.$Pengaturan->favicon) ?>" type="image/png">
    ...
    <link rel="stylesheet" href="<?php echo base_url('/public/assets/theme/quirk/lib/weather-icons/css/weather-icons.css')?>">
    <link rel="stylesheet" href="<?php echo base_url('/public/assets/theme/quirk/lib/ionicons/css/ionicons.css')?>">
    <link rel="stylesheet" href="<?php echo base_url('/public/assets/theme/quirk/lib/jquery-toggles/toggles-full.css')?>">
    <link rel="stylesheet" href="<?php echo base_url('/public/assets/theme/quirk/lib/morrisjs/morris.css')?>">

    <link rel="stylesheet" href="<?php echo base_url('/public/assets/theme/quirk/css/quirk.css')?>">

    <script src="<?php echo base_url('/public/assets/theme/quirk/lib/modernizr/modernizr.js')?>"></script>
...
<body>
    ...
    <script src="<?php echo base_url('/public/assets/theme/quirk/lib/jquery/jquery.js')?>"></script>
    <script src="<?php echo base_url('/public/assets/theme/quirk/lib/jquery-ui/jquery-ui.js')?>"></script>
    <script src="<?php echo base_url('/public/assets/theme/quirk/lib/bootstrap/js/bootstrap.js')?>"></script>
    <script src="<?php echo base_url('/public/assets/theme/quirk/lib/jquery-toggles/toggles.js')?>"></script>

    <script src="<?php echo base_url('/public/assets/theme/quirk/lib/morrisjs/morris.js')?>"></script>
    <script src="<?php echo base_url('/public/assets/theme/quirk/lib/raphael/raphael.js')?>"></script>

    <script src="<?php echo base_url('/public/assets/theme/quirk/lib/flot/jquery.flot.js')?>"></script>
    <script src="<?php echo base_url('/public/assets/theme/quirk/lib/flot/jquery.flot.resize.js')?>"></script>
    <script src="<?php echo base_url('/public/assets/theme/quirk/lib/flot-spline/jquery.flot.spline.js')?>"></script>

    <script src="<?php echo base_url('/public/assets/theme/quirk/lib/jquery-knob/jquery.knob.js')?>"></script>

    <script src="<?php echo base_url('/public/assets/theme/quirk/js/quirk.js')?>"></script>
    <script src="<?php echo base_url('/public/assets/theme/quirk/js/dashboard.js')?>"></script>
</body>
</html>