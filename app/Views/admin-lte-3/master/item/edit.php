                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <?= form_input(['id'=>'harga','name' => 'harga_beli', 'value' => old('harga_beli', $item->harga_beli ?? ''), 'class' => 'form-control rounded-0']) ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <?= form_input(['id'=>'harga','name' => 'harga_jual', 'value' => old('harga_jual', $item->harga_jual ?? ''), 'class' => 'form-control rounded-0']) ?>
                            </div>
                        </div>
                    </div>
                </div>
