                ...
                <tbody>
                    <?php if (!empty($platforms)): ?>
                        ...
                        foreach ($platforms as $platform):
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" class="select-item" value="<?= $platform->id ?>">
                                </td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    bulkDeleteBtn.addEventListener('click', function() {
        ...
        if (!confirm(`Apakah Anda yakin ingin menghapus ${itemIds.length} platform yang dipilih?`)) {
            return;
        }
        ...
        // Send AJAX request
        fetch('<?= base_url('master/platform/bulk_delete') ?>', {
            method: 'POST',
            headers: {
