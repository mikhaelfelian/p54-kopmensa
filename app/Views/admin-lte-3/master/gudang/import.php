    ...
    <div class="col-12">
        <div class="card rounded-0">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-file-import mr-2"></i>Import Data Gudang
                </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <?= form_open_multipart('master/gudang/import', ['class' => 'form-horizontal']) ?>
            ...
            <div class="card-footer">
                ...
                <a href="<?= base_url('master/gudang/template') ?>" class="btn btn-info rounded-0">
