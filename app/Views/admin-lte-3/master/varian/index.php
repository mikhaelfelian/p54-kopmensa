 ...
 * description : View for displaying varian/variant data
 * This file represents the Varian Index View.
 */
?>
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <a href="<?= base_url('master/varian/import') ?>" class="btn btn-sm btn-success rounded-0">
            ...
            <?php if ($pager): ?>
                <div class="card-footer clearfix">
                    <div class="float-right">
                        <?= $pager->links('varian', 'adminlte_pagination') ?>
                    </div>
                </div>
            <?php endif ?>
            </div>
