<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        <li class="nav-item d-flex align-items-center">
            ...
            <a href="<?= base_url() ?>" class="navbar-brand mr-3" style="padding: 0; margin-right: 1rem;">
                <img src="<?= $Pengaturan->logo ? base_url($Pengaturan->logo) : base_url('public/assets/theme/admin-lte-3/dist/img/AdminLTELogo.png') ?>"
                    alt="<?php echo $Pengaturan->judul; ?> Logo" style="height:32px; width:auto;">
                <span class="brand-text font-weight-light d-none d-md-inline"><?= $Pengaturan ? $Pengaturan->judul_app : env('app.name') ?></span>
            </a>
            <span class="nav-link" id="tanggalan" style="padding-left:0;">
