...
<div class="card rounded-0">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fas fa-money-bill-wave"></i> Petty Cash Management
        </h3>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <a href="<?= base_url('transaksi/petty/create') ?>" class="btn btn-primary">
                        <i class="fas fa-plus mr-2"></i>Tambah Petty Cash
                    </a>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="direction" id="direction" class="form-control">
                                        ...
                                        <option value="IN" <?= ($filters['direction'] == 'IN') ? 'selected' : '' ?>>Masuk</option>
                                        <option value="OUT" <?= ($filters['direction'] == 'OUT') ? 'selected' : '' ?>>Keluar</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-2">
                                ...
                                <?php if (!empty($pettyEntries)): ?>
                                    <?php foreach ($pettyEntries as $index => $item): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (isset($item->kategori_nama)): ?>
                                                    <?= $item->kategori_nama ?>
                                                <?php else: ?>
                                                    N/A
                                                <?php endif; ?>
                            ...
                            <nav>
                                <ul class="pagination">
                                    ...
                                    <?php if ($currentPage > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="<?= base_url('transaksi/petty?page=' . ($currentPage - 1) . '&' . http_build_query(array_diff_key($filters, ['page' => '']))) ?>">
                                                Previous
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                                        <li class="page-item <?= ($i == $currentPage) ? 'active' : '' ?>">
                                            <a class="page-link" href="<?= base_url('transaksi/petty?page=' . $i . '&' . http_build_query(array_diff_key($filters, ['page' => '']))) ?>">
                                                <?= $i ?>
                                            </a>
                                        </li>
                                    <?php endfor; ?>
